...
const translations = {
  uk: {
    nav: { concept: 'Ідея', arch: 'Архітектура', modules: 'Складові', roadmap: 'Плани' },
    ...
    arch: { tag: '02 / Архітектура', title: '6 Рівнів', highlight: 'Системи', desc: 'Кожен рівень системи працює злагоджено для повної самостійності.', layers: ['Залізо та датчики', 'Збір інформації', 'Пошук причин', 'Керування діями', 'Зручний інтерфейс', 'Автономна робота'], layersTags: ['Hardware', 'Context', 'Logic', 'Swarm', 'UX', 'Action'] },
    ...
    footer: { copy: '© 2026 BrainFlow Concept. Всі права захищені.', links: ['Ідея', 'Архітектура', 'Етика'] }
  },
  ru: {
